...
class Sample3Activity : AppCompatActivity(R.layout.back_stack_activity) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.addButton.setOnClickListener {
            ...
            supportFragmentManager.beginTransaction()
                .replace(R.id.fragment, Sample3Fragment.newInstance(text), text)
                .addToBackStack(text)
                .commit()
        }
        ...
        if (savedInstanceState == null) {
            ...
            supportFragmentManager.beginTransaction()
                .add(R.id.fragment, Sample3Fragment.newInstance(text), text)
                .commit()
        }
    }
}
